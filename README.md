...
The commands from this addon are available when the project type is a valid `drupal` type. Make sure the `type` configuration is correctly set in `.ddev/config.yaml`:
